class Sv {
  ...
  listFiles(uuid, query, callback) {
    let path = this.url(this.bpath + '/zipato-web/v2/sv/camera/' + uuid, query)
  ...
  delete(body, callback) {
    let path = this.url(this.bpath + '/zipato-web/v2/sv/deleteBatch')
  ...
  delete(id, callback) {
    let path = this.url(this.bpath + '/zipato-web/v2/sv/' + id)
  ...
  get(id, query, callback) {
    let path = this.url(this.bpath + '/zipato-web/v2/sv/' + id + '/dl', query)
