class Contacts {
  ...
  createUser(body, callback) {
    let path = this.url(this.bpath + '/zipato-web/v2/contacts')
  ...
  self(callback) {
    let path = this.url(this.bpath + '/zipato-web/v2/contacts/self')
  ...
  editUser(id, body, callback) {
    let path = this.url(this.bpath + '/zipato-web/v2/contacts/' + id)
