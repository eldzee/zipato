class Thermostats {
  ...
  findAll(query, callback) {
    let path = this.url(this.bpath + '/zipato-web/v2/thermostats', query)
  ...
  wrapThermostat(device, body, query, callback) {
    let path = this.url(this.bpath + '/zipato-web/v2/thermostats/wrap/' + device, query)
  ...
  delete(uuid, callback) {
    let path = this.url(this.bpath + '/zipato-web/v2/thermostats/' + uuid)
  ...
  findFull(uuid, query, callback) {
    let path = this.url(this.bpath + '/zipato-web/v2/thermostats/' + uuid, query)
  ...
  getConfig(uuid, callback) {
    let path = this.url(this.bpath + '/zipato-web/v2/thermostats/' + uuid + '/config')
  ...
  getActuatorConfig(uuid, operation, callback) {
    let path = this.url(this.bpath + '/zipato-web/v2/thermostats/' + uuid + '/config/' + operation)
  ...
  listInputs(uuid, operation, callback) {
    let path = this.url(this.bpath + '/zipato-web/v2/thermostats/' + uuid + '/config/' + operation + '/inputs/')
  ...
  addInput(uuid, operation, endpoint, query, callback) {
    let path = this.url(this.bpath + '/zipato-web/v2/thermostats/' + uuid + '/config/' + operation + '/inputs/' + endpoint, query)
  ...
  listMeters(uuid, operation, callback) {
    let path = this.url(this.bpath + '/zipato-web/v2/thermostats/' + uuid + '/config/' + operation + '/meters/')
  ...
  addMeter(uuid, operation, endpoint, query, callback) {
    let path = this.url(this.bpath + '/zipato-web/v2/thermostats/' + uuid + '/config/' + operation + '/meters/' + endpoint, query)
  ...
  listOutputs(uuid, operation, callback) {
    let path = this.url(this.bpath + '/zipato-web/v2/thermostats/' + uuid + '/config/' + operation + '/outputs')
  ...
  deleteOutput(uuid, operation, endpoint, query, callback) {
    let path = this.url(this.bpath + '/zipato-web/v2/thermostats/' + uuid + '/config/' + operation + '/outputs/' + endpoint, query)
  ...
  setValue(uuid, endpoint, attribute, body, callback) {
    let path = this.url(this.bpath + '/zipato-web/v2/thermostats/' + uuid + '/endpoints/' + endpoint + '/values/' + attribute)
  ...
  wrapThermostat(uuid, device, body, query, callback) {
    let path = this.url(this.bpath + '/zipato-web/v2/thermostats/' + uuid + '/wrap/' + device, query)
