class Sip {
  ...
  createContact(body, callback) {
    let path = this.url(this.bpath + '/zipato-web/v2/sip/contacts')
  ...
  updateContactShare(body, callback) {
    let path = this.url(this.bpath + '/zipato-web/v2/sip/contacts/share')
  ...
  getContact(id, callback) {
    let path = this.url(this.bpath + '/zipato-web/v2/sip/contacts/' + id)
  ...
  updateDevice(body, callback) {
    let path = this.url(this.bpath + '/zipato-web/v2/sip/devices')
  ...
  updateDeviceShare(body, callback) {
    let path = this.url(this.bpath + '/zipato-web/v2/sip/devices/share')
  ...
  getDevice(id, callback) {
    let path = this.url(this.bpath + '/zipato-web/v2/sip/devices/' + id)
  ...
  getDevice(id, serial, callback) {
    let path = this.url(this.bpath + '/zipato-web/v2/sip/devices/' + id + '/' + serial)
  ...
  deleteServer(callback) {
    let path = this.url(this.bpath + '/zipato-web/v2/sip/server')
  ...
  updateAditionalServer(body, callback) {
    let path = this.url(this.bpath + '/zipato-web/v2/sip/server/additional')
  ...
  addAditionalServer(query, callback) {
    let path = this.url(this.bpath + '/zipato-web/v2/sip/server/additional', query)
  ...
  bindServerGroup(body, query, callback) {
    let path = this.url(this.bpath + '/zipato-web/v2/sip/server/additional/contacts', query)
  ...
  deleteAditionalServerContact(body, callback) {
    let path = this.url(this.bpath + '/zipato-web/v2/sip/server/additional/contacts')
