class Users {
  ...
  findAll(callback) {
    let path = this.url(this.bpath + '/zipato-web/v2/users')
  ...
  me(callback) {
    let path = this.url(this.bpath + '/zipato-web/v2/users/current')
  ...
  createMember(query, callback) {
    let path = this.url(this.bpath + '/zipato-web/v2/users/member', query)
  ...
  roleCount(role, callback) {
    let path = this.url(this.bpath + '/zipato-web/v2/users/roles/' + role + '/count')
  ...
  save(id, callback) {
    let path = this.url(this.bpath + '/zipato-web/v2/users/' + id)
  ...
  getBoxUser(id, callback) {
    let path = this.url(this.bpath + '/zipato-web/v2/users/' + id + '/boxUser')
  ...
  modify(id, query, callback) {
    let path = this.url(this.bpath + '/zipato-web/v2/users/' + id + '/modify', query)
