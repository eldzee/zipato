class Meteo {
  ...
  create(body, callback) {
    let path = this.url(this.bpath + '/zipato-web/v2/meteo')
  ...
  findAllValues(query, callback) {
    let path = this.url(this.bpath + '/zipato-web/v2/meteo/attributes/values', query)
  ...
  findFull(uuid, query, callback) {
    let path = this.url(this.bpath + '/zipato-web/v2/meteo/attributes/' + uuid, query)
  ...
  searchLocation(query, callback) {
    let path = this.url(this.bpath + '/zipato-web/v2/meteo/city', query)
  ...
  searcWeather(query, callback) {
    let path = this.url(this.bpath + '/zipato-web/v2/meteo/weather', query)
  ...
  delete(uuid, callback) {
    let path = this.url(this.bpath + '/zipato-web/v2/meteo/' + uuid)
  ...
  conditions(uuid, callback) {
    let path = this.url(this.bpath + '/zipato-web/v2/meteo/' + uuid + '/conditions')
  ...
  forecast(uuid, day, callback) {
    let path = this.url(this.bpath + '/zipato-web/v2/meteo/' + uuid + '/forecast/' + day)
