class Rules {
  ...
  findAll(query, callback) {
    let path = this.url(this.bpath + '/zipato-web/v2/rules', query)
  ...
  create(callback) {
    let path = this.url(this.bpath + '/zipato-web/v2/rules/')
  ...
  getByUuid(id, callback) {
    let path = this.url(this.bpath + '/zipato-web/v2/rules/' + id)
  ...
  getCode(id, callback) {
    let path = this.url(this.bpath + '/zipato-web/v2/rules/' + id + '/code')
