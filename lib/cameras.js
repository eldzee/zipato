class Cameras {
  ...
  getAll(query, callback) {
    let path = this.url(this.bpath + '/zipato-web/v2/cameras', query)
  ...
  proxy(query, callback) {
    let path = this.url(this.bpath + '/zipato-web/v2/cameras/proxy', query)
  ...
  findFull(uuid, query, callback) {
    let path = this.url(this.bpath + '/zipato-web/v2/cameras/' + uuid, query)
  ...
  delete(uuid, callback) {
    let path = this.url(this.bpath + '/zipato-web/v2/cameras/' + uuid)
  ...
  update(uuid, body, callback) {
    let path = this.url(this.bpath + '/zipato-web/v2/cameras/' + uuid + '/config')
  ...
  configure(uuid, callback) {
    let path = this.url(this.bpath + '/zipato-web/v2/cameras/' + uuid + '/configure')
  ...
  ptzPatrol(uuid, patrol, callback) {
    let path = this.url(this.bpath + '/zipato-web/v2/cameras/' + uuid + '/ptz/patrol/' + patrol)
  ...
  ptzPreset(uuid, preset, callback) {
    let path = this.url(this.bpath + '/zipato-web/v2/cameras/' + uuid + '/ptz/preset/' + preset)
  ...
  ptzAction(uuid, action, callback) {
    let path = this.url(this.bpath + '/zipato-web/v2/cameras/' + uuid + '/ptz/' + action)
  ...
  recording(uuid, callback) {
    let path = this.url(this.bpath + '/zipato-web/v2/cameras/' + uuid + '/takeRecording')
  ...
  snapshot(uuid, callback) {
    let path = this.url(this.bpath + '/zipato-web/v2/cameras/' + uuid + '/takeSnapshot')
