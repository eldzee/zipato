class Rooms {
  ...
  getAll(callback) {
    let path = this.url(this.bpath + '/zipato-web/v2/rooms/')
  ...
  flush(callback) {
    let path = this.url(this.bpath + '/zipato-web/v2/rooms/flush')
  ...
  delete(room, callback) {
    let path = this.url(this.bpath + '/zipato-web/v2/rooms/' + room)
