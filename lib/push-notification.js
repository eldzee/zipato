class PushNotification {
  ...
  getApnsDevTokens(callback) {
    let path = this.url(this.bpath + '/zipato-web/v2/push-notification/apns/dev-tokens')
  ...
  addApnsDevTokens(query, callback) {
    let path = this.url(this.bpath + '/zipato-web/v2/push-notification/apns/dev-tokens/add', query)
  ...
  registerApns0(token, callback) {
    let path = this.url(this.bpath + '/zipato-web/v2/push-notification/apns/register/' + token)
  ...
  sendApnsNotification(query, callback) {
    let path = this.url(this.bpath + '/zipato-web/v2/push-notification/apns/send', query)
  ...
  registerApns(token, callback) {
    let path = this.url(this.bpath + '/zipato-web/v2/push-notification/apns/token/' + token)
  ...
  registerGcm0(token, callback) {
    let path = this.url(this.bpath + '/zipato-web/v2/push-notification/gcm/register/' + token)
  ...
  sendGcmNotification(query, callback) {
    let path = this.url(this.bpath + '/zipato-web/v2/push-notification/gcm/send', query)
  ...
  registerGcm(token, callback) {
    let path = this.url(this.bpath + '/zipato-web/v2/push-notification/gcm/token/' + token)
  ...
  sendAll(query, callback) {
    let path = this.url(this.bpath + '/zipato-web/v2/push-notification/send', query)
