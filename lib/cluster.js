class Cluster {
  ...
  list(callback) {
    let path = this.url(this.bpath + '/zipato-web/v2/cluster')
  ...
  add(serial, callback) {
    let path = this.url(this.bpath + '/zipato-web/v2/cluster/add/' + serial)
  ...
  join(serial, callback) {
    let path = this.url(this.bpath + '/zipato-web/v2/cluster/join/' + serial)
  ...
  getCluster(cluster, callback) {
    let path = this.url(this.bpath + '/zipato-web/v2/cluster/' + cluster)
  ...
  getActiveMembers(cluster, callback) {
    let path = this.url(this.bpath + '/zipato-web/v2/cluster/' + cluster + '/active')
  ...
  getMembers(cluster, callback) {
    let path = this.url(this.bpath + '/zipato-web/v2/cluster/' + cluster + '/members')
  ...
  setActive(cluster, member, body, callback) {
    let path = this.url(this.bpath + '/zipato-web/v2/cluster/' + cluster + '/members/' + member)
