class Wizard {
  ...
  create(name, callback) {
    let path = this.url(this.bpath + '/zipato-web/v2/wizard/create/' + name)
  ...
  cancel(transaction, callback) {
    let path = this.url(this.bpath + '/zipato-web/v2/wizard/tx/' + transaction + '/cancel')
  ...
  next(transaction, callback) {
    let path = this.url(this.bpath + '/zipato-web/v2/wizard/tx/' + transaction + '/next')
  ...
  poll(transaction, callback) {
    let path = this.url(this.bpath + '/zipato-web/v2/wizard/tx/' + transaction + '/poll')
  ...
  repeat(transaction, callback) {
    let path = this.url(this.bpath + '/zipato-web/v2/wizard/tx/' + transaction + '/repeat')
