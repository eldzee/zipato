class Bindings {
  ...
  findAll(query, callback) {
    let path = this.url(this.bpath + '/zipato-web/v2/bindings', query)
  ...
  findPossibleBindings(query, callback) {
    let path = this.url(this.bpath + '/zipato-web/v2/bindings/check', query)
  ...
  findFull(uuid, query, callback) {
    let path = this.url(this.bpath + '/zipato-web/v2/bindings/' + uuid, query)
  ...
  delete(uuid, callback) {
    let path = this.url(this.bpath + '/zipato-web/v2/bindings/' + uuid)
  ...
  findOne(uuid, callback) {
    let path = this.url(this.bpath + '/zipato-web/v2/bindings/' + uuid + '/config')
