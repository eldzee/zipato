class Snapshot {
  ...
  factoryDefault(query, callback) {
    let path = this.url(this.bpath + '/zipato-web/v2/snapshot/factoryDefault/restore', query)
  ...
  create(serial, body, callback) {
    let path = this.url(this.bpath + '/zipato-web/v2/snapshot/' + serial)
  ...
  getInfo(serial, uuid, callback) {
    let path = this.url(this.bpath + '/zipato-web/v2/snapshot/' + serial + '/' + uuid)
  ...
  restore(serial, uuid, callback) {
    let path = this.url(this.bpath + '/zipato-web/v2/snapshot/' + serial + '/' + uuid + '/restore')
