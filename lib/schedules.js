class Schedules {
  ...
  findAll(query, callback) {
    let path = this.url(this.bpath + '/zipato-web/v2/schedules', query)
  ...
  create(callback) {
    let path = this.url(this.bpath + '/zipato-web/v2/schedules/')
  ...
  getByUuid(uuid, query, callback) {
    let path = this.url(this.bpath + '/zipato-web/v2/schedules/' + uuid, query)
  ...
  delete(uuid, callback) {
    let path = this.url(this.bpath + '/zipato-web/v2/schedules/' + uuid)
  ...
  getConfig(uuid, callback) {
    let path = this.url(this.bpath + '/zipato-web/v2/schedules/' + uuid + '/config')
