class Scenes {
  ...
  findAll(query, callback) {
    let path = this.url(this.bpath + '/zipato-web/v2/scenes', query)
  ...
  create(callback) {
    let path = this.url(this.bpath + '/zipato-web/v2/scenes/')
  ...
  flush(query, callback) {
    let path = this.url(this.bpath + '/zipato-web/v2/scenes/flush', query)
  ...
  findOne(uuid, callback) {
    let path = this.url(this.bpath + '/zipato-web/v2/scenes/' + uuid)
  ...
  invoke(uuid, callback) {
    let path = this.url(this.bpath + '/zipato-web/v2/scenes/' + uuid + '/run')
