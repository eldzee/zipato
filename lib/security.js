class Security {
  ...
  changePin(secureSessionId, body, callback) {
    let path = this.url(this.bpath + '/zipato-web/v2/security/session/changePin/' + secureSessionId)
  ...
  initSession(callback) {
    let path = this.url(this.bpath + '/zipato-web/v2/security/session/init/')
  ...
  initChangePin(secureSessionId, body, callback) {
    let path = this.url(this.bpath + '/zipato-web/v2/security/session/initPin/' + secureSessionId)
  ...
  keepalive(secureSessionId, callback) {
    let path = this.url(this.bpath + '/zipato-web/v2/security/session/keepalive/' + secureSessionId)
  ...
  login(secureSessionId, query, callback) {
    let path = this.url(this.bpath + '/zipato-web/v2/security/session/login/' + secureSessionId, query)
  ...
  logout(secureSessionId, callback) {
    let path = this.url(this.bpath + '/zipato-web/v2/security/session/logout/' + secureSessionId)
