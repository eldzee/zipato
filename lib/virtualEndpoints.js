class VirtualEndpoints {
  ...
  findAll(query, callback) {
    let path = this.url(this.bpath + '/zipato-web/v2/virtualEndpoints', query)
  ...
  findFull(uuid, query, callback) {
    let path = this.url(this.bpath + '/zipato-web/v2/virtualEndpoints/' + uuid, query)
  ...
  delete(uuid, callback) {
    let path = this.url(this.bpath + '/zipato-web/v2/virtualEndpoints/' + uuid)
  ...
  update(uuid, body, callback) {
    let path = this.url(this.bpath + '/zipato-web/v2/virtualEndpoints/' + uuid + '/config')
